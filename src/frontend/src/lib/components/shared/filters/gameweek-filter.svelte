...
<div class="flex w-full flex-col">
  ...
  <div class="flex items-center">
    <button
      class={`${ selectedGameweek === 1 ? "inactive-backend-button" : "backend-button" } default-button mr-1`}
    ...
    <select
      class="p-2 backend-dropdown text-center mx-0 md:mx-2 min-w-[125px]"
    ...
    <button
      class={`${ selectedGameweek === lastGameweek ? "inactive-backend-button" : "backend-button" } default-button ml-3`}
